...
**Status:** Draft  
**Target Application(s):** [Specify which apps: api, web, jobmaster, jobmaster-gui, shared]  
...
### Testing Strategy
[Unit tests, integration tests, end-to-end tests required]
...
### Open Questions
[Questions that need to be resolved during the RFC process]
