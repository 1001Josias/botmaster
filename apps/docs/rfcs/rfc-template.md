...
1. Copy this template to the appropriate location:
   - Application-specific RFCs: apps/[app]/docs/rfcs/NNNN-brief-title.md
   - Cross-cutting RFCs: apps/docs/rfcs/shared/NNNN-brief-title.md
2. Use 4-digit zero-padded RFC numbers (e.g., 0001, 0042, 0123)
3. Fill out all relevant sections below
4. Submit as Draft PR with 'rfc' label
5. Follow the RFC process outlined in apps/docs/rfcs/README.md

Example placements:
- apps/api/docs/rfcs/0001-user-authentication-system.md
- apps/docs/rfcs/shared/0001-unified-logging-strategy.md
-->

**Status:** Draft  
**Target Application(s):** [api, web, jobmaster, jobmaster-gui, packages] <!-- Select from: api, web, jobmaster, jobmaster-gui, packages. Use "shared" for cross-cutting concerns -->
