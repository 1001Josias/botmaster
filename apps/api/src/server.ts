...
import { workerInstallationRouterV1 } from './api/workers/installations/workerInstallationRoutes'
...
apiRouterV1.use('/workers/installations', workerInstallationRouterV1)
// Routes
