...
import { Database, MessageSquare, Clock, AlertTriangle } from 'lucide-react'

export function QueuesStats() {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Total de Queues</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">0.17% do total</p>
        </CardContent>
      </Card>
    </div>
  )
